{**
 * plugins/generic/multipressIndex/templates/frontend/components/monographListMultipress.tpl
 *
...
<div class="cmp_monographs_list">
	...
	{foreach name="monographListLoop" from=$monographs item=monograph}
		{if $counter is odd by 1}
			<div class="row">
		{/if}
			{include file=$monographSummaryTemplate monograph=$monograph isFeatured=false heading=$monographHeading authorUserGroups=$authorUserGroups}
